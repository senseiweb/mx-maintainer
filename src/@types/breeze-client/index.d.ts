...
// export declare namespace breeze {
...
//     //     addTypeToStore(store: MetadataStore, typeDef: ComplexTypeOptions | EntityTypeProperties): ComplexType | EntityType;
//     //     convertValidators(typeName: string, propName: string, propDef: any): void;
//     //     findEntityKey(typeDef: EntityTypeProperties): DataPropertyOptions;
//     //     inferDefaultResourceName(typeDef: EntityTypeProperties): void;
//     //     inferValidators(entityType: EntityTypeProperties): EntityTypeProperties;
//     //     patch(typeDef: EntityTypeProperties): void;
...
// export declare namespace breeze.config {
...
// export declare namespace breeze.promises {
