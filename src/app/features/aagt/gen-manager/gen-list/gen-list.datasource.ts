...
import { AssetTriggerAction, Generation } from 'app/features/aagt/data';
...
export class GenListDataSource extends DataSource<Generation> {
    ...
    connect(): Observable<Generation[]> {
        ...
        return merge(...displayDataChanges).pipe(
            map(noChoice => {
                let genData = this.genMgrUow.allGenerations;
        ...
        return genData.sort((a: Generation, b: Generation) => {
            ...
            switch (this.sort.active) {
                ...
                case 'assignedAssetCount':
                    [propertyA, propertyB] = [
                        a.assignedAssetCount,
                        b.assignedAssetCount
                    ];
                    break;
            }
