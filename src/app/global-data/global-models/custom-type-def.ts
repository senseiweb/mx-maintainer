        ...
        for (const oKey of objKeys) {
            ...
            for (const key of propKeys) {
                ...
                if (key === 'spInternalName' && prop.spInternalName) {
                    const dict = this.typeClientToServerDictionary ? this.typeClientToServerDictionary : {};
                    const dictKey = `${this.shortName}:#${this.namespace}`;
                    dict[dictKey] = { oKey: prop[key] };
