...
import { ISpEntityType, MetadataBase, SpEntityBase, SpEntityDecorator } from '../models';
...
export class BaseEmProviderService {
    ...
    init(): void {
        ...
        appModels.forEach(app => {
            const entity = app as any as SpEntityDecorator;
            entity._makeNameingDict(this.featureNameSpace, clientToServerNameDictionary, entity);
            entity._createTypeInStore(this.entityManager.metadataStore);
        });
