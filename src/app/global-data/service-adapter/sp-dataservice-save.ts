import { SaveContext, SaveBundle, SaveResult, Entity, AutoGeneratedKeyType, DataProperty, DataType, HttpResponse, EntityKey, EntityState } from 'breeze-client';
...
export class CustomSaveContext {
    ...
    private prepareSaveBundles(): Promise<Entity>[] {
