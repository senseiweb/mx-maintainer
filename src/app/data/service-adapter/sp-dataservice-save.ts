import { SaveContext, SaveBundle, SaveResult, Entity, AutoGeneratedKeyType, DataProperty, DataType, HttpResponse, EntityKey } from 'breeze-client';
...
export class CustomSaveContext {
    ...
    private makeSaveResult(response: HttpResponse, index: number): SaveResult {
        ...
        if (data && typeof data === 'object') {
            ...
            data.$entityType = response.saveContext.originalEntities[index].entityType;
